...
public class Yacochuya extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yacochuya);
    ...
    private void prepareAlbums() {
        final String[] wordsYacochuya = getResources().getStringArray(R.array.yacochuya);
        int[] yacochuyaVinos = new int[]{
                R.drawable.vacio};
        int[] fondos = new int[]{
                R.drawable.fv8};
