...
public class Colome extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_colome);
    ...
    private void prepareAlbums() {
        final String[] wordsColome = getResources().getStringArray(R.array.colome);
        int[] colomeVinos = new int[]{
